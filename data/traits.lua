-- traits.lua -- bludex trait ladder (GENERATED 2026-08-11 by tools/generate_spells.py -- DO NOT EDIT)
...
M.categories[4] = { name = 'Clear Mind', traitId = 24, tiers = { { points = 8, traitId = 24, mods = { { stat = 'CLEAR_MIND', value = 1 } } }, { points = 16, traitId = 24, mods = { { stat = 'CLEAR_MIND', value = 2 } } }, { points = 24, traitId = 24, mods = { { stat = 'CLEAR_MIND', value = 3 } } }, { points = 32, traitId = 24, mods = { { stat = 'CLEAR_MIND', value = 4 } } }, { points = 40, traitId = 24, mods = { { stat = 'CLEAR_MIND', value = 5 } } }, { points = 48, traitId = 24, mods = { { stat = 'CLEAR_MIND', value = 6 } } } } }
...
M.categories[6] = { name = 'Magic Atk. Bonus', traitId = 5, tiers = { { points = 8, traitId = 5, mods = { { stat = 'MATT', value = 20 } } }, { points = 16, traitId = 5, mods = { { stat = 'MATT', value = 24 } } }, { points = 24, traitId = 5, mods = { { stat = 'MATT', value = 28 } } }, { points = 32, traitId = 5, mods = { { stat = 'MATT', value = 32 } } }, { points = 40, traitId = 5, mods = { { stat = 'MATT', value = 36 } } }, { points = 48, traitId = 5, mods = { { stat = 'MATT', value = 40 } } } } }
M.categories[7] = { name = 'Undead Killer', traitId = 39, tiers = { { points = 8, traitId = 39, mods = { { stat = 'UNDEAD_KILLER', value = 8 } } } } }
M.categories[8] = { name = 'Attack Bonus', traitId = 3, tiers = { { points = 8, traitId = 3, mods = { { stat = 'ATT', value = 10 }, { stat = 'RATT', value = 10 } } }, { points = 16, traitId = 3, mods = { { stat = 'ATT', value = 22 }, { stat = 'RATT', value = 22 } } }, { points = 24, traitId = 3, mods = { { stat = 'ATT', value = 35 }, { stat = 'RATT', value = 35 } } }, { points = 32, traitId = 3, mods = { { stat = 'ATT', value = 48 }, { stat = 'RATT', value = 48 } } }, { points = 40, traitId = 3, mods = { { stat = 'ATT', value = 60 }, { stat = 'RATT', value = 60 } } } } }
...
M.categories[14] = { name = 'Auto Refresh', traitId = 10, tiers = { { points = 8, traitId = 10, mods = { { stat = 'REFRESH', value = 1 } } }, { points = 16, traitId = 10, mods = { { stat = 'REFRESH', value = 2 } } } } }
...
M.categories[22] = { name = 'Fast Cast', traitId = 12, confidence = 'verify', tiers = { { points = 8, traitId = 12, mods = { { stat = 'FASTCAST', value = 5 } } }, { points = 16, traitId = 12, mods = { { stat = 'FASTCAST', value = 15 } } }, { points = 24, traitId = 12, mods = { { stat = 'FASTCAST', value = 20 } } } } }
